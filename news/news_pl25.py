...
path_pen(x_mat=x_mat, y_mat=x_mat, NP_SEED=OPT_SEED, TF_SEED=OPT_SEED, BATCH_DIV=5, LOAD_APDX='phase0_'+SAVE_NAME+'_best', DIM_H=dim_h, DIM_Z=DIM_Z, EPOCHS=epochs2, LBDA_EXCL=LBDA_EXCL, LBDA_PATH=LBDA_PATH, START_BEST=1000, LOG_NAME=LOG_NAME)
