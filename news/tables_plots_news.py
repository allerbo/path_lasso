...
print('Algorithm & Connections & $R^2$ & Reconstruction Match \\\\')
print('\\hline')
print('Path lasso & ' +str(conns(W_GL_pl))+' & '+ round1(r2(x_val, rec_pl))+ ' & ' + round1(rm_pl)+ ' & ' + round1(rm_cl_pl) + '\\\\')
print('Standard Lasso & ' +str(conns(W_GL_l1))+' & '+ round1(r2(x_val, rec_l1))+ ' & ' + round1(rm_l1)+ ' & ' + round1(rm_cl_l1) + '\\\\')
print('Sparse PCA & ' +str(conns(W_sp))+' & '+ round1(r2(x_val, rec_sp))+ ' & ' + round1(rm_sp)+' & ' + round1(rm_cl_sp)+ '\\\\')
#
